...
export function Dashboard() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main className="mx-auto flex w-[96%] max-w-300 flex-1 flex-col gap-4 pt-6 md:w-[90%]">
            ...
            {error ? (
              ...
              <>
                <div className="overflow-x-hidden">
                  <table className="table table-zebra table-fixed w-full [&_td]:px-2 [&_th]:px-2 sm:[&_td]:px-4 sm:[&_th]:px-4">
                          ...
                          <tr key={`file:${file.path}`}>
                            <td className="min-w-0 font-medium">
                              <span className="flex w-full min-w-0 items-start gap-1 sm:gap-2 align-middle">
                                <Icon
                                  icon={fileIcon.icon}
                                  className={`h-5 w-5 shrink-0 ${fileIcon.color}`}
                                />
                                <span className="min-w-0 truncate">{file.name}</span>
                              </span>
                            </td>
                            <td
                              className="hidden text-base-content/50 sm:table-cell"
                              style={{ fontSize: 13 }}
                            >
                              <span
                                className="tooltip"
                            ...
                            <td
                              className="hidden whitespace-nowrap text-base-content/50 sm:table-cell"
                              style={{ fontSize: 13 }}
                            >
                            ...
                            <td className="text-right">
                              <div className="flex justify-end gap-1 sm:gap-2">
                                <button
                                  type="button"
                                  className={`btn btn-ghost btn-xs btn-square sm:btn-sm ${downloadingPath === file.path ? "loading" : ""}`}
                                  disabled={busy}
